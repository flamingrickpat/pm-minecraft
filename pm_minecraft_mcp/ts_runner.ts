...
function createContext(bodyUrl: string): MinecraftContext {
  ...
  return {
    ...
    findBlock: (blockName) => call("find_block", { blockName }, 15),
    walkTo: (target, tolerance = 1.5, timeoutSeconds = 60) => call("walk_to_visible", { target, tolerance }, timeoutSeconds),
    ...
    smelt: (inputItemName, inputCount, fuelItemName, fuelCount = 1) => call(
      "smelt",
      { inputItemName, inputCount, fuelItemName, fuelCount },
      180
    ),
