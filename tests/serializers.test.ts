  ...
  it("returns health shape with process, config, Mineflayer, Paper, and viewer status", () => {
    expect(
      serializeHealth({
        ...
        config: {
          minecraft: { host: "127.0.0.1", port: 25565, username: "bot", mineVisibilityIgnoreDistance: 3, walkToMaxDistance: 16 },
      ...
      config: { minecraft: { host: "127.0.0.1", port: 25565, username: "bot", mineVisibilityIgnoreDistance: 3, walkToMaxDistance: 16 } },
